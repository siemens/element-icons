# Contributing to Siemens Element Icons
...
[Issues](https://github.com/siemens/element-icons/issues) that might help you. In case
...
- Open an [Issue](https://github.com/siemens/element-icons/issues/new).
...
- To see if other users have experienced (and potentially already solved) the
  ...
  for your bug or error in the [bug tracker](https://github.com/siemens/element-icons/issues?q=label%3Abug).
...
- Open an [Issue](https://github.com/siemens/element-icons/issues/new). (Since we can't
...
- Perform a [search](https://github.com/siemens/element-icons/issues) to see if the
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/siemens/element-icons/issues).
